                ...
                <div className="grid grid-cols-1 gap-4 lg:grid-cols-[200px_1fr] lg:gap-8 py-4">
                    <div id="sidebar" className="flex flex-col gap-2 min-h-screen">
                        <input
                            ...
                            type="button" value="Zapisz" id="save" disabled={!canEdit}/>
                        <input
                            className="text-center inline-block rounded border border-indigo-600 bg-indigo-600 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 disabled:bg-gray-300 disabled:border-gray-300"
                            type="button" value="Zamień plik" id="upload" disabled={!canUpload}/>
                        ...
                        <div className="p-3 bg-gray-200 rounded-lg">
                            ...
                            <div className="mt-2">
                                {directories.map((directory, i) => (
                                    <div key={i} onClick={() => gotToSubDirectory(directory)} className="flex flex-row gap-2 p-2 hover:bg-gray-300 rounded-lg cursor-pointer">
                        ...
                        <div className="p-3 bg-gray-200 rounded-lg">
                            ...
                            <div className="mt-2">
                                {files.map((file, i) => (
                                    <div key={i} onClick={() => changeFile(file)} className="flex flex-row gap-2 p-2 hover:bg-gray-300 rounded-lg cursor-pointer">
                    ...
                    <div id="editor" className="w-full h-full rouded-md">
                        ...
                        />}
                        {image !== null && <img src={"data:image/png;base64, " + image} alt="Podgląd obrazka" className="w-full h-full object-contain"/>}
                    </div>
