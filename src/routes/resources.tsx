    ...
    return (
        <div className="flex gap-4 flex-col lg:flex-row p-10 min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="rounded-lg bg-gray-100 dark:bg-gray-800 p-10 gap-1 flex-grow flex flex-col gap-4">
                <h1 className="text-3xl font-bold dark:text-white">Zasoby</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 flex-wrap rounded gap-7 justify-around align-items-center">
                    {files.map((file: string) => (
                        <div className="p-7 bg-white dark:bg-gray-900 text-center flex flex-col gap-3 rounded shadow-lg justify-between items-center">
                    ...
                    {files.length == 0 && <p className="text-red-600 p-3 bg-red-200 dark:bg-red-950 text-center rounded border border-red-500">Nie masz
