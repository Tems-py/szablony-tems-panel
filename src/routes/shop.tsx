    ...
    const downloadZip = () => {
        axios({
            ...
            .then((response) => {
                ...
                link.href = url;
                link.setAttribute('download', `${shop.id}_backup.zip`); // filename
    ...
    return (
        <div className="w-full">
            <div className="h-full w-full rounded-lg bg-gray-100 p-3 lg:p-10 grid grid-cols-1 md:grid-cols-4 gap-4">
                <section
                    className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 md:p-6 flex flex-col gap-4 md:col-span-3">
                ...
                <section className="bg-white rounded-lg shadow-sm border border-gray-200 px-6 py-3 flex flex-col gap-3">
                    ...
                    <p className="text-md">Tutaj sprawdzisz czy szablon uruchomił się poprawnie oraz znajdziesz
                ...
                <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 md:p-6"><Reinstall
                    shop={shop}
                    types={types}/>
                </section>
                <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 md:p-6 md:col-span-2">
                    <AdminList/></section>
                <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 md:p-6"><Restart
                    shop={shop}/></section>
            </div>
        </div>
    )
